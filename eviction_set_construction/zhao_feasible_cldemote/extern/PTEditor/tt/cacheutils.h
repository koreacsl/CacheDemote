...
// ---------------------------------------------------------------------------
void cldemote(void *p) { asm volatile("cldemote 0(%0)\n" : : "c"(p) : "rax"); }

// ---------------------------------------------------------------------------
void prefetch(void *p) { asm volatile("prefetcht2 0(%0)\n" : : "c"(p) : "rax"); }

// ---------------------------------------------------------------------------
void clwb(void *p) { asm volatile("clwb 0(%0)\n" : : "c"(p) : "rax"); }
